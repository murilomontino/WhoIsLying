...
export const ON_ADD_SKILL_HISTORIC = 'ON_ADD_SKILL_HISTORIC'
export const ON_ADD_SKILL_HISTORIC_SUCCESS = 'ON_ADD_SKILL_HISTORIC_SUCCESS'
export const ON_ADD_SKILL_HISTORIC_FAIL = 'ON_ADD_SKILL_HISTORIC_FAIL'
...
export const ACTION_ADD_SKILL_HISTORIC = `${name}/${ON_ADD_SKILL_HISTORIC}`
export const ACTION_ADD_SKILL_HISTORIC_SUCCESS = `${name}/${ON_ADD_SKILL_HISTORIC_SUCCESS}`
export const ACTION_ADD_SKILL_HISTORIC_FAIL = `${name}/${ON_ADD_SKILL_HISTORIC_FAIL}`
